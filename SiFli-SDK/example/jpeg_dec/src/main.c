...
int main(void)
{
    ...
    jpeg_decode_init();
    ret = jpeg_decode_get_dimension((uint8_t *)&jpeg_data[0], jpeg_data_len, &width, &height);
    ...
    if (0 == ret)
    {
        ...
        ret = jpeg_decode2((uint8_t *)&jpeg_data[0], jpeg_data_len, decode_format, out_buf, out_buf_size);
